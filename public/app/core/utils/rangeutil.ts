...
var rangeOptions = [
  ...
  //   { from: 'now-5y',   to: 'now',      display: 'Last 5 years',          section: 0 },
    ...
    { from: 'now-5m',   to: 'now',      display: 'Last 5 minutes',        section: 1 },
    ...
    { from: 'now-3h',   to: 'now',      display: 'Last 3 hours',          section: 1 },
    { from: 'now-6h',   to: 'now',      display: 'Last 6 hours',          section: 1 },
    ...
    { from: 'now-2d/d', to: 'now-2d/d', display: 'Day before yesterday',  section: 0 },
];
